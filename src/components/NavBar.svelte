    ...
    <div class="main-dropdown" slot="left">
      <div class="dropdown is-horizontal-align">
        <Button dropdown="HUMAN RESOURCES" autoclose clear>
          <p>
            <a href="/manage">Manage employees</a>
          </p>
          <p>
            <a href="/skills">Manage employee skills</a>
          </p>
          <p>
            <a href="/positions">Manage employee positions</a>
          </p>
          <p>
            <a href="/folderView">Main</a>
          </p>
          <p>
            <a href="/test">Draggable test</a>
          </p>
        </Button>
      </div>
    </div>
